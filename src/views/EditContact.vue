      ...
      <div class="row">
        <div class="col-md-4">
          <form action="">
            ...
            <div class="mb-2">
              <input type="text" class="form-control" placeholder="Enter Photo URL">
            </div>
            <div class="mb-2">
              <input type="email" class="form-control" placeholder="Enter Your Email">
            </div>
            <div class="mb-2">
              <input type="number" class="form-control" placeholder="Enter Your Mobile">
            </div>
            <div class="mb-2">
            ...
            <div class="mb-2">
              <input type="text" class="btn btn-success" value="Record Update">
            </div>
          </form>
        </div>
        <div class="col-md-4">
